...
public class RemainEvaluatedFragment extends BaseFragment implements BaseQuickAdapter.RequestLoadMoreListener
{
...
//        mAdapter.setNewData(mList);
    ...
    private void getData(final int page)
    {
        ...
        HttpUtils.get(NetConstant.EVALUATE, hashMap, new DialogCallBack((Refreshable) RemainEvaluatedFragment.this)
        {
            @Override
            public void onResponse(String response, int id)
            {
