...
public class ObligationFragment extends BaseFragment implements BaseQuickAdapter.RequestLoadMoreListener
{
...
//        mAdapter.setNewData(mList);
    ...
    private void getData(final int page)
    {
        ...
        HttpUtils.get(NetConstant.UNPAID, hashMap, new DialogCallBack((Refreshable) ObligationFragment.this)
        {
            @Override
            public void onResponse(String response, int id)
            {
