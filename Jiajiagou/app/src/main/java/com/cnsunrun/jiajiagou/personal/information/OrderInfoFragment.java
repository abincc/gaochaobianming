...
public class OrderInfoFragment extends BaseFragment implements BaseQuickAdapter.OnItemClickListener {
    ...
    protected void init() {
        ...
        HttpUtils.get(NetConstant.ORDER_MESSAGE, map, new StringCallback() {
            @Override
    ...
    public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
        ...
        bundle.putString(ConstantUtils.MESSAGE_TYPE,"订单");
