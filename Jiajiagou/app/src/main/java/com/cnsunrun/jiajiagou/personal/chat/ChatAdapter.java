...
public class ChatAdapter extends RecyclerView.Adapter<ChatAdapter.BaseAdapter> {
    ...
    public ChatAdapter.BaseAdapter onCreateViewHolder(ViewGroup parent, int viewType) {
        switch (viewType) {
            ...
            case ItemModel.CHAT_T:
                return new ChatTViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.chat_time, parent, false));
        }
        return null;
    }
    ...
    private class ChatTViewHolder extends BaseAdapter {
        private TextView tv;

        public ChatTViewHolder(View view) {
            super(view);
            tv = (TextView) itemView.findViewById(R.id.tv_time);
        }
