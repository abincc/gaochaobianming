...
public class MultiPickResultView extends FrameLayout {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        // 帖子详情显示需要一行6个
        recyclerView.setLayoutManager(new StaggeredGridLayoutManager(6, OrientationHelper
                .VERTICAL));
    ...
    public MultiPickResultView(Context context, AttributeSet attrs, int defStyleAttr, int
            defStyleRes) {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (action == ACTION_SELECT) {
            PhotoPickUtils.onActivityResult(requestCode, resultCode, data, new PhotoPickUtils
                    .PickHandler() {
                @Override
