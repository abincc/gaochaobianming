 ...
 * @time 2016-06-30
 */
class CleanServiceController extends IndexController {
	
	/**
	 * 表名
	 * @var string
	 */
	protected $table  = 'Clean_service';
	...
	protected function update(){
		...
		$rules[] = array('title','require','服务类型名称必须',1);
		...
		F('clean_service_no_hid',null);
		F('clean_service_no_del',null);
