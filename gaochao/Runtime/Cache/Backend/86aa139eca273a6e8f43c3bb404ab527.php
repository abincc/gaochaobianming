	...
	<div class="box box-body">
		<form action="" method="post" class="js_form">
			...
			<div class="form-group">
				...
				<div>
					<select name="pid" class="form-control width_auto super_select2" data-placeholder="请选择父级" datatype="n" nullmsg="请选择父级" errormsg="请选择父级">
			...
			<div class="form-group">
				...
				<div>
					<?php
 $config = array( 'index' => 1, 'table' => 'product_category', 'table_id' => 'id', 'name' => 'icon', 'multi' => 'false', 'val_key' => 'icon' ); echo W('Common/Img/index', array($config, $info['id'])); ?>
					<span class="Validform_checktip">可不传，图标尺寸：</span>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div>
					<input type="text" class="form-control width_auto" name="sort" value="<?=$info['sort']?>" datatype="n" nullmsg="请输入排序" errormsg="请输入排序" />
