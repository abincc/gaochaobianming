 ...
 if($small_tips){ ?>
	...
	<div class="box box-body">
		<form action="" method="post" class="js_form">
			...
			<div>
				<input type="number" class="form-control width_auto" name="mobile" value="<?=$info['mobile']?>" datatype="*7-11" nullmsg="请输入电话号码" errormsg="请输入电话号码" placeholder="请输入电话号码"/>
			...
			<div>
				<input type="start_date" style="min-width:auto;width:140px!important" onclick="WdatePicker({skin:'backend',dateFmt:'yyyy-MM-dd'})" class="form-control input-sm wdate" placeholder="生日" name="birthday" value="<?=$info['birthday']?>">
				<span class="Validform_checktip">7-11个字符</span>
			</div>
