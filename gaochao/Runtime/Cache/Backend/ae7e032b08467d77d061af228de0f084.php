			...
			<tr>
				<th colspan="20" class="text-right clearfix">
					<form action="<?=U('index');?>" class="form-inline pull-left" method="get">
						<input type="text" class="form-control input-sm" placeholder="名称" name="keywords" value="<?=$keywords?>">
...
<div class="noneshowlist text-center" style="height:auto;line-height:normal;">
 ...
 foreach($list as $row){ ?>
			<tr>
				...
				<td>
					<?=$cache[$row['province']]['title'].$cache[$row['city']]['title'].$cache[$row['area']]['title'].$row['address']?>
				</td>
