 ...
 if($small_tips){ ?>
	...
	<div class="box box-body">
		<form action="" method="post" class="js_form">
			...
			<div>
				<input type="text" class="form-control width_auto" name="username" value="<?=$info['username']?>" datatype="*0-250" nullmsg="请输入用户名" errormsg="请输入用户名" placeholder="请输入用户名"/>
				<span class="Validform_checktip">0-250个字符</span>
			</div>
			...
			<div class="form-group">
				...
				<div>
					<select name="type" class="form-control width_auto super_select2" data-placeholder="费用类型" datatype="n" nullmsg="请选择费用类型" errormsg="请选择费用类型">
			...
			<div class="form-group">
				...
				<div>
					<input type="text" class="form-control width_auto" name="cost_time" value="<?=substr($info['cost_time'], 0, 10)?>" datatype="*10-10" nullmsg="请输入费用日期" errormsg="请输入费用日期" placeholder="请输入费用日期"/>
			...
			<div class="form-group">
				...
				<div>
					<?php
 $config = array( 'index' => 1, 'table' => 'comprehensive', 'table_id' => 'id', 'name' => 'image', 'multi' => 'false', 'val_key' => 'image' ); echo W('Common/Img/index', array($config, $info['id'])); ?>
