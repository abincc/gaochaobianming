			...
			<tr>
				<th colspan="9" class="clearfix">
					<form action="<?=U('index');?>" class="form-inline pull-left" method="get">
						<input type="text" class="form-control input-md" style="width: 250px;" placeholder="申请人姓名|联系电话" name="keywords" value="<?=$keywords?>">
						<?php
 if(!session('is_owner')){ ?>
...
<!-- 				<th width="10%" class="text-center">邮箱</th> -->
				<th width="16%" class="text-center">志愿开始日期</th>
				<th width="16%" class="text-center">志愿结束日期</th>
