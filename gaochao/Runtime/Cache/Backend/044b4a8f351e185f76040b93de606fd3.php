	...
	<div class="box box-body">
		<form action="" method="post" class="js_form">
			...
			<div class="form-group">
                ...
                <div>
                <select name="video_id" class="form-control input-md super_select2 width_auto" data-placeholder="请选择账号">
			...
			<div class="form-group">
				...
				<div>
					<input type="text" class="form-control width_auto" name="ezopen" value="<?=$info['ezopen']?>" datatype="*3-100" nullmsg="请直播源地址" errormsg="请直播源地址" placeholder="请直播源地址"/>
					<span class="Validform_checktip">3-100个字符</span>
				</div>
			</div>
			<div class="form-group">
				<div class="control-label">
				...
				<div>
					<?php
 $config = array( 'index' => 1, 'table' => 'videoDevice', 'table_id' => 'id', 'name' => 'image', 'multi' => 'false', 'val_key' => 'image' ); echo W('Common/Img/index', array($config, $info['id'])); ?>
			...
			<div class="form-group">
				...
				<div>
					<input type="text" class="form-control width_auto" name="title" value="<?=$info['title']?>" datatype="*3-16" nullmsg="请输入标题" errormsg="请输入标题" placeholder="请输入标题"/>
					<span class="Validform_checktip">3-16个字符</span>
				</div>
			</div>
			<div class="form-group">
				<div class="control-label">
				...
				<div>
					<input type="text" class="form-control width_auto" name="remark" value="<?=$info['remark']?>" datatype="*0-150" nullmsg="请输入详细信息" errormsg="请输入详细信息" placeholder="请输入详细信息"/>
					<span class="Validform_checktip">0-150个字符</span>
				</div>
			</div>
