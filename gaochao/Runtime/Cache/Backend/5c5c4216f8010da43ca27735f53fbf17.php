...
<div class="message_bg js_message_bg"></div>
 ...
 if(!session('is_owner')){ ?>
			<div class="form-group">
				...
				<div>
					<select name="district_id" class="form-control width_auto super_select2" data-placeholder="请选择父级" datatype="n" nullmsg="请选择父级" errormsg="请选择父级">
			...
			<div class="form-group">
				<div>
					<?php  $district = get_no_hid('district','add_time desc'); $district_id = session('district_id'); ?>
					<strong><?=$district[$district_id]['title']?></strong>
			...
			<div class="form-group">
				...
				<div>
					<input type="text" class="form-control width_auto" name="title" value="<?=$info['title']?>" datatype="*1-20" nullmsg="请输入车位名称" errormsg="请输入车位名称" />
			...
			<div class="form-group">
				...
				<div>
					<?php
 $config = array( 'index' => 1, 'table' => 'parking', 'table_id' => 'id', 'name' => 'image', 'multi' => 'false', 'val_key' => 'image' ); echo W('Common/Img/index', array($config, $info['id'])); ?>
			...
			<div class="form-group">
				...
				<div>
					<input type="text" class="form-control width_auto" name="sort" value="<?=$info['sort']?$info['sort']:'0'?>" datatype="n" nullmsg="请输入排序" errormsg="请输入排序" />
