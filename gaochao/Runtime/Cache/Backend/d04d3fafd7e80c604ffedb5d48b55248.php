	...
	<table class="table js_table table-bordered">
		...
		<tbody>
			<tr role="row">
				...
				<th width="6%" class="text-center">凭证编号</th>
				<th width="6%" class="text-center">收入</th>
				<th width="5%" class="text-center">支出</th>
...
<div class="noneshowlist text-center" style="height:auto;line-height:normal;">
 ...
 foreach($list as $row){ ?>
			<tr>
				...
				<td class="text-center"><?=$row['credence']?></td>
				<td class="text-center"><?=$row['income']?></td>
				<td class="text-center"><?=$row['expenses']?></td>
