	...
	<table class="table js_table table-bordered">
		...
		<tbody>
			<tr role="row">
				...
				<th width="10%" class="text-center">费用类型</th>
				<th width="8%" class="text-center">费用</th>
...
<div class="noneshowlist text-center" style="height:auto;line-height:normal;">
 ...
 foreach($list as $row){ ?>
			<tr>
				...
				<td class="text-center"><?=$type[$row['type']]['remark']?></td>
				<td class="text-center"><?=$row['cost']?></td>
				<td class="text-center"><?=substr($row['cost_time'], 0, 10)?></td>
