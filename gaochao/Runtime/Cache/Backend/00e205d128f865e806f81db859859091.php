	...
	<table class="table js_table table-bordered">
		...
		<tbody>
			<tr role="row">
				...
				<th width="6%" class="text-center">职位</th>
				<th width="6%" class="text-center">添加/修改用户</th>
...
<div class="noneshowlist text-center" style="height:auto;line-height:normal;">
 ...
 foreach($list as $row){ ?>
			<tr>
				...
				<td class="text-center"><?=$row['member']['username']?></td>
				<td class="text-center"><?=$row['member']['mobile']?></td>
				<td class="text-center"><?=$type_s[$row['job_id']]['title']?></td>
				<td class="text-center"><?=$row['admin']['username']?></td>
