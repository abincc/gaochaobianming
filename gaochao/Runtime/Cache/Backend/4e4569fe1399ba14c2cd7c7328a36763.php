	...
	<div class="box box-body">
		<form action="" method="post" class="js_form">
			...
			<div class="form-group">
				...
				<div>
					<select id="member" name="member_id" class="form-control width_auto super_select2" data-placeholder="请选择用户" datatype="n" nullmsg="请选择用户" errormsg="请选择用户">
			...
			<div class="form-group">
				...
				<div>
					<select name="job_id" class="form-control width_auto super_select2" data-placeholder="请选择职位" datatype="n" nullmsg="请选择职位" errormsg="请选择职位">
