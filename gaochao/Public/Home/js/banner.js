...
var banner_btn = $('.js_banner_btn a');
...
$('.js_imglist_3d li').width(w_w).height(w_w*600/750);
banner_btn.eq(kc_now).addClass('active');
...
function succeed() {
    ...
    banner_btn.eq(kc_now).addClass('active').siblings('a').removeClass('active');
